        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 rounded-2xl border border-white/10 p-6 shadow-2xl backdrop-blur-xl" style={{ background: "rgba(0,0,0,0.35)" }}>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <Input id="dateOfBirth" type="date" className="border-white/15 bg-white/[0.08] text-white placeholder:text-white/40 focus-visible:ring-primary/50 [color-scheme:dark]" {...register("dateOfBirth")} />
            ...
            <div>
              ...
              <Input id="age" type="number" placeholder="Age" className="border-white/15 bg-white/[0.08] text-white placeholder:text-white/40 focus-visible:ring-primary/50" {...register("age")} />
          ...
          <div>
            ...
            <select
              id="gender"
              {...register("gender")}
              className="flex h-10 w-full rounded-md border border-white/15 bg-white/[0.08] px-3 py-2 text-sm text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
            >
          ...
          <div>
            ...
            <Input id="mobileNumber" placeholder="10-digit mobile number" className="border-white/15 bg-white/[0.08] text-white placeholder:text-white/40 focus-visible:ring-primary/50" {...register("mobileNumber")} />
            {errors.mobileNumber && <p className="mt-1 text-xs text-red-400">{errors.mobileNumber.message}</p>}
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <Input
                ...
                className="border-white/15 bg-white/[0.08] text-white placeholder:text-white/40 focus-visible:ring-primary/50"
                {...register("password")}
              />
              <button
                type="button"
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase"><span className="px-2 text-white/40" style={{ background: "rgba(0,0,0,0.35)" }}>or</span></div>
          </div>

          <Button type="button" variant="outline" className="w-full rounded-xl border-white/15 bg-white/[0.08] text-white hover:bg-white/15 hover:text-white" onClick={handleGoogleSignIn}>
